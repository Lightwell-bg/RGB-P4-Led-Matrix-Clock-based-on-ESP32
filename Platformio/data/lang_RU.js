var langRU = {
	...
	P_led_z3_date:"Дата",
	P_rdata_title:"Настройка получения данных",
	//YouTube special for NEW ESR32Screen
	P_youtube_title:"Оповещение от YouTube",
	P_youtube_informer:"Необходимо получить ключ API и знать номер канала и номер видео, которые хотим отслеживать.",
	P_google_linkAPI:"здесь инструкция получения API,",
	P_youtube_IDs:"здесь как узнать ID канала и видео",
	P_google_key:"API",
	P_channel_id:"ID канала",
	P_video_id:"ID видео",
	P_shop_zone:"Настройки магазина",
	P_shop_on:"Магазин открыт",
	P_shop_informer:"Shop setup page",
	P_shop_link:"open",
